...
DOMAIN = "google.com" FQDN = "mail.google.com" SLEEP_TIME = 10 * 60 # Seconds between checks

Variable Description

DOMAIN The Cloudflare-managed zone (root domain).

FQDN The fully qualified domain name (DNS record) to update.

SLEEP_TIME Interval, in seconds, between IP checks.
